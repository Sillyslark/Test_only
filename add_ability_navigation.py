...
NAV_START = "<!-- ABILITY_NAV_START -->"
NAV_END = "<!-- ABILITY_NAV_END -->"
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Add navigation to Ability subsection Markdown files."
    )
    parser.add_argument(
        "section_dir",
        type=Path,
        help="Directory containing README.md and numbered Ability subsection files",
    )
    parser.add_argument(
        "--remove",
        action="store_true",
