...
def test_case_01_basic() -> None:
    case_root = REPO_ROOT / "tests" / "fixtures" / "scanner" / "case_01_basic"
    cards_root = case_root / "cards"

    expected_path = (
        REPO_ROOT / "tests" / "expected" / "scanner" / "case_01_basic.json"
    )
    artifact_path = (
        REPO_ROOT / "tests" / "artifacts" / "scanner" / "case_01_basic.json"
    )
