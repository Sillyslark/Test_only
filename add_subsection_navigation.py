...
NAV_START = "<!-- SUBSECTION_NAV_START -->"
NAV_END = "<!-- SUBSECTION_NAV_END -->"
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Add navigation to numbered subsection Markdown files."
    )
    parser.add_argument(
        "section_dir",
        type=Path,
        help="Directory containing README.md and files like 01_xxx.md, 02_xxx.md",
    )
    parser.add_argument(
        "--remove",
        action="store_true",
